...
export default function Home() {
    return (
        <>
            <Head
                title="מנגינות לתפילה"
                description="מאגר שירים ומנגינות לקטעי התפילה השונים. כולל קבלת שבת מוזיקלית והלל מוזיקלי. רוצה לחנים ללכה דודי? עולה חזן בתפילת החג הקרובה? זה בדיוק המקום בשבילך"
            />
